...
import IulEsRcAnClient from "./pageClient";
...
export default async function IulEsRcAnPage() {
  ...
  return (
    <>
      <Script id="meta-pixel-pageview-rc-an" strategy="beforeInteractive">
...
fbq('init', '${META_PIXEL_ID}');`}
      ...
      <Script id="tiktok-pixel-pageview-rc-an" strategy="beforeInteractive">
        {`!function (w, d, t) {
...
;n.type="text/javascript",n.async=!0,n.src=r+"?sdkid="+e+"&lib="+t;e=document.getElementsByTagName("script")[0];e.parentNode.insertBefore(n,e)};
  ...
  ttq.load('${TIKTOK_PIXEL_ID}');
      ...
      <IulEsRcAnClient
        heroImage="/marta-cheque-rc-an.png"
