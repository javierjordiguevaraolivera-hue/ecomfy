...
import IulEsRcAn2Client from "./pageClient";
...
export default async function IulEsRcAn2Page() {
  ...
  return (
    <>
      <Script id="meta-pixel-pageview-rc-an2" strategy="beforeInteractive">
...
fbq('track', 'PageView');`}
      ...
      <Script id="tiktok-pixel-pageview-rc-an2" strategy="beforeInteractive">
        {`!function (w, d, t) {
...
;n.type="text/javascript",n.async=!0,n.src=r+"?sdkid="+e+"&lib="+t;e=document.getElementsByTagName("script")[0];e.parentNode.insertBefore(n,e)};
  ...
  ttq.page();
      ...
      <IulEsRcAn2Client
        heroImage="/marta-cheque-rc-an2.png"
