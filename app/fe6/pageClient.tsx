...
const LANDING_KEY = "fe6-an-en";
const PHONE_LABEL = "Call now: +1 (855) 668-5535";
const PHONE_HREF = "tel:+18556685535";

const INTRO_MESSAGES = [
  "Hi there.",
  "I'm Megan from Quiet Legacy's Final Expense team.",
  "To help match you with the right coverage, what is your age range?",
];
...
const SUCCESS_HTML =
  "<strong>✅ Great news! You are pre-qualified for Final Expense Coverage. 🙌</strong><br><br>We reserved a licensed advisor to help you review today's coverage options and rates. This pre-qualification is time-sensitive.<br><br>Tap the call button below 📞 to receive your free consultation and see what you may qualify for today.";
...
export default function Fe6Client() {
  const [items, setItems] = useState<ChatItem[]>([
    { id: "initial-loader", type: "loader", content: "Typing..." },
  ]);
  ...
  function handleOption(value: OptionValue) {
    ...
    setItems((current) => [
      ...
      },
      {
        ...
        type: "loader",
        content: "Checking your qualification...",
      },
    ]);
  ...
  return (
    <main className={styles.page}>
      <div className={styles.topBar}>
        <ShieldIcon />
        <span>
          Over <strong>12,000 families</strong> have already explored affordable
          final expense options. Start your review today.
        </span>
        <HandMoneyIcon />
      </div>
      ...
      <section className={styles.header}>
        ...
        <div className={styles.headline}>
          Want to help protect your loved ones from funeral costs and final
          expenses? Our program makes it simple to review affordable options.
        </div>
        <div className={styles.subtext}>
          We help adults compare final expense coverage options starting from as
          low as $1/day, often with no medical exam required.
        </div>
      </section>
      ...
      <footer className={styles.footer}>
        <p>
          Copyright 2026, All rights reserved. This site is not part of
          Facebook or Facebook Inc. This site is not endorsed by Facebook in any
          way. Facebook is a trademark of Facebook, Inc.
        </p>
        <p>
          <a href="#">Terms and Conditions</a> | <a href="#">Legal Notice</a> |{" "}
