import IulEsJdClient from "./pageClient";
...
export default async function IulEsJdPage() {
  ...
  return (
    <>
      ...
      <IulEsJdClient
        heroImage="/familia-judios-jd.png"
