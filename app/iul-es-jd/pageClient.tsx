...
const LANDING_KEY = "iul-es-jd";
const CLAIM_URL = "https://seguro.generaldeals.info/";
const ARTICLE_HEADLINE =
  "El mayor secreto financiero que se ha mantenido oculto por decadas";
const ARTICLE_HEADLINE_ACCENT = "ya ha sido revelado";
const ARTICLE_SUBHEAD =
  "Las cuentas indexadas pueden dar hasta $650,000 para deudas, negocio o universidad.";
const SELECTED_AMOUNT = "$600,000";
...
const QUICK_FACTS = [
  ...
  },
  {
    ...
    body: "Las revisiones mas comunes hoy se concentran entre $300,000 y $600,000 de proteccion potencial.",
  },
  {
...
const FAQS = [
  ...
  {
    question: "Esto garantiza $600,000?",
    answer:
...
const TESTIMONIALS = [
  {
    image: "/Dorothy W-testimonial1-jd.jpg",
    name: "Leah M.",
    city: "Brooklyn, NY",
    quote:
  ...
  {
    image: "/robert h-testimonial2-jd.jpg",
    name: "Daniel R.",
    city: "Miami, FL",
    quote:
  ...
  {
    image: "/Maria & Carlos L-testimonial3-jd.jpg",
    name: "Sara y Eli T.",
    city: "Los Angeles, CA",
    quote:
...
export default function IulEsJdClient({
  heroImage,
  publishedLabel,
  city,
  state,
      ...
      <header className={styles.masthead}>
        <div className={styles.mastheadInner}>
          ...
          <div className={styles.brandRow}>
            <div>
              <p className={styles.brand}>Informe Patrimonial</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <aside className={styles.sidebar}>
          <div className={styles.sidebarCard}>
            ...
            <ul className={styles.sidebarList}>
              ...
              <li>Hoy el mayor interes esta alrededor del umbral de $600,000.</li>
            </ul>
            <button
              type="button"
