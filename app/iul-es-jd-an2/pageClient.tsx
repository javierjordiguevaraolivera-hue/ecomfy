...
const LANDING_KEY = "iul-es-jd-an2";
...
const TESTIMONIALS = [
  {
    image: "/Dorothy W-testimonial1-jd-an2.jpg",
  ...
  {
    image: "/robert h-testimonial2-jd-an2.jpg",
    name: "Daniel S.",
    city: "Houston, TX",
    quote:
  ...
  {
    image: "/Maria & Carlos L-testimonial3-jd-an2.jpg",
    name: "Lidia y Saul R.",
    city: "Scottsdale, AZ",
    quote:
    ...
    <main className={styles.page}>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerInner}>
          <Image
            src="/logo-iul-negativo-jd-an2.png"
            alt="IUL Life"
            width={170}
            height={52}
