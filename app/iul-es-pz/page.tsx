import IulEsPzClient from "./pageClient";
...
export default async function IulEsPzPage() {
  ...
  return (
    <>
      ...
      <IulEsPzClient
        heroImage="/influencer-viral-pizarra-pz.png"
