...
import IulEsJdAn4Client from "./pageClient";
...
export default async function IulEsJdAn4Page() {
  ...
  return (
    <>
      <Script id="meta-pixel-pageview-jd-an4" strategy="beforeInteractive">
...
fbq('track', 'PageView');`}
      ...
      <Script id="tiktok-pixel-pageview-jd-an4" strategy="beforeInteractive">
        {`!function (w, d, t) {
...
;n.type="text/javascript",n.async=!0,n.src=r+"?sdkid="+e+"&lib="+t;e=document.getElementsByTagName("script")[0];e.parentNode.insertBefore(n,e)};
  ...
  ttq.page();
      ...
      <IulEsJdAn4Client
        heroImage="/judio-rico-aconceja-iul-jd-an4.png"
