...
import IulEsJdAn3Client from "./pageClient";
...
export default async function IulEsJdAn3Page() {
  ...
  return (
    <>
      <Script id="meta-pixel-pageview-jd-an3" strategy="beforeInteractive">
...
fbq('track', 'PageView');`}
      ...
      <Script id="tiktok-pixel-pageview-jd-an3" strategy="beforeInteractive">
        {`!function (w, d, t) {
...
;n.type="text/javascript",n.async=!0,n.src=r+"?sdkid="+e+"&lib="+t;e=document.getElementsByTagName("script")[0];e.parentNode.insertBefore(n,e)};
  ...
  ttq.page();
      ...
      <IulEsJdAn3Client
        heroImage="/familia-judios-jd-an3.png"
