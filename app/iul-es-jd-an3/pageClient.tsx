...
const LANDING_KEY = "iul-es-jd-an3";
...
const TESTIMONIALS = [
  {
    image: "/Dorothy W-testimonial1-jd-an3.jpg",
    name: "Leah M.",
    city: "Brooklyn, NY",
    quote:
  ...
  {
    image: "/robert h-testimonial2-jd-an3.jpg",
    name: "Daniel R.",
    city: "Miami, FL",
    quote:
  ...
  {
    image: "/Maria & Carlos L-testimonial3-jd-an3.jpg",
    name: "Sara y Eli T.",
    city: "Los Angeles, CA",
    quote:
...
export default function IulEsJdAn3Client({
  heroImage,
  publishedLabel,
  city,
  state,
    ...
    <main className={styles.page}>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerInner}>
          <Image
            src="/logo-iul-negativo-jd-an3.png"
            alt="IUL Life"
            width={170}
            height={52}
